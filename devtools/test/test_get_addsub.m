...
[A_spread_s, sort_info_s ]= get_spread(kern_0, kern, src_info_2d, ...
grid_info, proxy_info);


[A_spread_t, sort_info_t ]= get_spread(kern_0, kern, targ_info_2d, ...
grid_info, proxy_info);
...
[A_spread_s, sort_info_s ]= get_spread(kern_0, kern, src_info_3d, ...
