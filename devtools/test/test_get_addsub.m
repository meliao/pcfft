...
[A_spread_s, sort_info_s, spread_blk_s] = get_spread(kern_0, kern, src_info_2d, ...
grid_info, proxy_info);


[A_spread_t, sort_info_t, spread_blk_t] = get_spread(kern_0, kern, targ_info_2d, ...
grid_info, proxy_info);
...
[A_spread_s, sort_info_s, spread_blk_s] = get_spread(kern_0, kern, src_info_3d, ...
grid_info_3d, proxy_info_3d);


[A_spread_t, sort_info_t, spread_blk_t] = get_spread(kern_0, kern, targ_info_3d, ...
grid_info_3d, proxy_info_3d);
