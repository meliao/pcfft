...
nbin = 4;
[r_sorted, sorted_bin_ids, id_start] = bin_pts_2d(src_info_2d.r, grid_info.dx, grid_info.ngrid, grid_info.Lbd, nbin);
...
for bin_id = 0:N_bins-1
    % disp("On bin_id = " + int2str(bin_id))

    [pts, center, row_idxes] = grid_pts_for_bin_2d(bin_id, grid_info, nbin);
    % disp("Row_idxes: ")
    % disp(row_idxes)
