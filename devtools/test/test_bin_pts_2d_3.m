...
[r_sorted, bin_idxes, id_start] = bin_pts_2d(r, dx, ngrid, Lbd, nbin);
...
[r_sorted2, bin_idxes2, id_start2] = bin_pts_2d(r2, dx, ngrid, Lbd, nbin);
...
[r_sorted3, bin_idxes3, id_start3] = bin_pts_2d(r3, dx, ngrid, Lbd, nbin);
