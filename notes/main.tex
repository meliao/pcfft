...
\begin{align*}
  \sum_{j \not \in \text{Near}(x_i)} K(x_i - y_j) \mu_j \approx \sum_{k}  K(x_i - z_k)\boldsymbol{A}_{k, :} \boldsymbol{\mu},
\end{align*}
...
\begin{align}
  \sum_{j \not \in \text{Near}(x_i)} K(x_i - y_j) \mu_j  = \boldsymbol{A}^T\tilde{\boldsymbol{K}} \boldsymbol{A} \boldsymbol{\mu},
\end{align}
...
\begin{align*}
  \boldsymbol{B}_{i,:} \boldsymbol{\mu} &= \sum_{j \in \text{Near}(x_i)} K(x_i - y_j) \boldsymbol{\mu}_j -  \sum_{k}  K(x_i - z_k)\boldsymbol{A}_{k, \text{Near}(i)} \boldsymbol{\mu}_{\text{Near}(i)} \\
...
$\boldsymbol{A}^{(\text{sub})}_{i,j}$ is equal to $(\boldsymbol{A}^T\tilde{\boldsymbol{K}} \boldsymbol{A})_{i,j}$ if $j\in \text{Near}(x_i)$ and zero otherwise. 
Then we can evaluate \eqref{eq:full_sum} as:
\begin{align*}
  u_i &= \sum_{j \in \text{Near}(x_i)} K(x_i - y_j) \mu_j + \sum_{j \not \in \text{Near}(x_i)} K(x_i - y_j) \mu_j \\
  &= \boldsymbol{A}^{(\text{add})}_{i,:} \boldsymbol{\mu} - \boldsymbol{A}^{(\text{sub})}_{i,:}  \boldsymbol{\mu}  + \boldsymbol{A}^T\tilde{\boldsymbol{K} }\boldsymbol{A} \boldsymbol{\mu}
\end{align*}
...
\begin{itemize}
  ...
  \item Compute the contribution of the near-field interactions to $\sum_{k}  K(x_i - z_k)\boldsymbol{A}_{k, \text{Near}(i)} \boldsymbol{\mu}$.
\end{itemize}
