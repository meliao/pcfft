...
[A_spread_s, sort_info_c, spread_blk_s] = get_spread(skern, ekern, chnkr, ...
    grid_info, proxy_info, {'r','n','d'});
[A_spread_c, ~, spread_blk_c] = get_spread(skern, @(s,t) bkern(t,s).', chnkr, ...
    grid_info, proxy_info, {'r','n','d'});
[A_spread_t, sort_info_t, spread_blk_t] = get_spread(skern, skern, targout, ...
    grid_info, proxy_info);
% build corrections
A_addsub_c = get_addsub(skern, fkern, grid_info, proxy_info, ...
    sort_info_c, sort_info_c, spread_blk_s, spread_blk_c);
A_addsub_eval = get_addsub(skern, ekern, grid_info, proxy_info, ...
    sort_info_c, sort_info_t, spread_blk_s, spread_blk_t);
% get DFT of kernel
