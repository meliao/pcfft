...
[A_spread_s, sort_info_S_over, spread_blk_s] = get_spread(skern, dkern, S_over, ...
    grid_info, proxy_info, {'r','n'});
[A_spread_surf, sort_info_S, spread_blk_surf] = get_spread(skern, skern, S, ...
...
A_addsub_self = get_addsub(skern, dkern, grid_info, proxy_info, ...
    sort_info_S_over, sort_info_S, spread_blk_s, spread_blk_surf);
A_addsub_eval = get_addsub(skern, dkern, grid_info, proxy_info, ...
    sort_info_S_over, sort_info_t, spread_blk_s, spread_blk_t);
% get DFT of kernel
